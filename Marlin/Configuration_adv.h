 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN  //beagle
...
#define BEEP_ON_FEEDRATE_CHANGE //beagle
...
#define STATUS_MESSAGE_SCROLLING //beagle

// On the Info Screen, display XY with one decimal place when possible
//#define LCD_DECIMAL_SMALL_XY

// The timeout (in ms) to return to the status screen from sub-menus
#define LCD_TIMEOUT_TO_STATUS 15000 //beagle
...
#define TX_BUFFER_SIZE 256 //beagle

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
#define RX_BUFFER_SIZE 2048  //beagle

#if RX_BUFFER_SIZE >= 1024
  // Enable to have the controller send XON/XOFF control characters to
  // the host to signal the RX buffer is becoming full.
  #define SERIAL_XON_XOFF //beagle
#endif
 ...
 */
#define EMERGENCY_PARSER //beagle
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH            0  // (mm) Initial retract.
    //beagle                                                // This short retract is done immediately, before parking the nozzle.
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      50  // (mm) The length of filament for a complete unload.
       ...
       //beagle                                             //   For direct drive, the full length of the nozzle.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         50  // (mm) Length to extrude after loading.
     ...
     //beagle                                               //   Filament can be extruded repeatedly from the Filament Change menu
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           190  // (seconds) Time limit before the nozzle is turned off for safety.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       950 //beagle        // (mA) RMS current. Multiply by 1.414 for peak current.
...
#define G0_FEEDRATE 1500 // (mm/min)
#ifdef G0_FEEDRATE
